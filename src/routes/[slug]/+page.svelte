...
<style>
    ...
    #gameController {
        ...
        height: 200px;  /* keeps aspect ratio because of viewBox */
    }

</style>
{#if toggle}
    <h1 transition:slide={{duration:1000}} id="title"><span style:color="rgb(255, 179, 217)">TAGGIE</span> CONNECTED</h1>
    <br>
    <h2 transition:fly={{delay:500, y:200, duration:1000}} id="player"><span >Player {player.toUpperCase()}</span></h2>
    <br>
<!-- License: CC Attribution. Made by Shannon E. Thomas: https://dribbble.com/shannonethomas -->
    <svg id="gameController" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" 
        ...
        <path transition:draw={{delay:1000, duration:1000}} class="stone_een" d="M26,17c0,0.551-0.449,1-1,1s-1-0.449-1-1s0.449-1,1-1S26,16.449,26,17z M20,17c-0.551,0-1,0.449-1,1
